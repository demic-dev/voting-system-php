...
<head>
    ...
    <script type="module" src="/web/js/platform/profile/polls/new.js"></script>

    <link rel="stylesheet" href="/web/css/globals.css">
    <link rel="stylesheet" href="/web/css/platform/profile/polls/new.css">

    <title data-translation="LABELS.new_poll.title"></title>
</head>
...
<body>
    ...
    <form class="container form__container">
        <div class="form__section">
            <h1 class="form__heading" data-translation="LABELS.new_poll.details_heading"></h1>

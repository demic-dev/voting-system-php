...
<head>
    ...
    <script type="module" src="/web/js/platform/profile/polls/index.js"></script>

    <link rel="stylesheet" href="/web/css/globals.css">
    <link rel="stylesheet" href="/web/css/platform/profile/userlists/index.css">

    <title data-translation="LABELS.your_polls.title"></title>
</head>
    ...
    <main class="container">
        ...
        <div class="contents__container" id="polls__container">
            <div class="alert alert-light empty_state__container">
                ...
                <h4 data-translation="LABELS.states.polls"></h4>
            </div>
        </div>
    </main>
</body>

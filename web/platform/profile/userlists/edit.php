...
<head>
    ...
    <script type="module" src="/web/js/platform/profile/userlists/edit.js"></script>

    <link rel="stylesheet" href="/web/css/globals.css">
    <link rel="stylesheet" href="/web/css/platform/profile/userlists/new.css">

    <title data-translation="LABELS.edit_userlist.title"></title>
</head>

<body>
    <?php include_once "../../../header.php"; ?>
    <form class="form__container">
        <h1 class="form__heading" data-translation="LABELS.edit_userlist.title"></h1>
